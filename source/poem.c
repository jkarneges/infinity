...
char poemstr[2][7][35] = {
    {"Time moves forward,", "Taking us like leaves in the wind.", "We meet, we come together,",
     "And then fall to the earth.",      "Longing for the spring...","Longing for life...", "But all things end."               },
    {                   "",        "The seasons pass eternally,", "And vanish like the stars,", "", "Yet spring always comes again,",
     "Bringing rebirth and new hope.",                    ""},
};
