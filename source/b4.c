...
BYTE tab_slurptab[64] = {48,  48,  47,  46,  46,  44,  43,  42,  40,  38,  37,  35,  32,  30,  28,  25,
                         23,  20,  17,  14,  12,  9,   6,   3,   0,   -1,  -4,  -7,  -9,  -12, -14, -16,
                         -18, -20, -22, -24, -25, -27, -28, -29, -30, -30, -31, -31, -31, -31, -30, -30,
                         -29, -28, -27, -26, -24, -22, -21, -19, -17, -14, -12, -10, -7,  -4,  -2,  0};
...
BYTE tab_panel_rel[6][32][2] = {
    {
     // 0,0 to 0,-32
     {0, -4},   {0, -7},  {0, -10},    {0, -12},   {0, -14},   {0, -16},   {0, -18},    {0, -19},{0, -21},   {0, -22},   {0, -23},
     {0, -24},   {0, -25},   {0, -26},   {0, -26},   {0, -27},{0, -28},   {0, -28},   {0, -29},   {0, -29},   {0, -29},   {0, -30},
     {0, -30},   {0, -30},{0, -31},   {0, -31},   {0, -31},   {0, -31},   {0, -31},   {0, -31},   {0, -31},   {0, -32},
     },
    {
     // 0,0 to -28,-16
     {-3, -2}, {-6, -4}, {-8, -5}, {-11, -6}, {-12, -7}, {-14, -8}, {-16, -9}, {-17, -10},
     {-18, -11}, {-19, -11}, {-20, -12}, {-21, -12}, {-22, -13}, {-23, -13}, {-23, -13}, {-24, -14},
     {-24, -14}, {-25, -14}, {-25, -15}, {-25, -15}, {-26, -15}, {-26, -15}, {-26, -15}, {-27, -15},
     {-27, -16}, {-27, -16}, {-27, -16}, {-27, -16}, {-27, -16}, {-28, -16}, {-28, -16}, {-28, -16},
     },
    {
     // 0,0 to -28,16
     {-3, 2},  {-6, 4},  {-8, 5},  {-11, 6},  {-12, 7},  {-14, 8},  {-16, 9},  {-17, 10},
    ...
    {
     // 0,0 to 28,16
     {3, 2},   {6, 4},   {8, 5},   {11, 6},   {12, 7},   {14, 8},   {16, 9},   {17, 10}, {18, 11},   {19, 11},   {20, 12},
     {21, 12},   {22, 13},   {23, 13},   {23, 13},   {24, 14}, {24, 14},   {25, 14},   {25, 15},   {25, 15},   {26, 15},   {26, 15},
     {26, 15},   {27, 15}, {27, 16},   {27, 16},   {27, 16},   {27, 16},   {27, 16},   {28, 16},   {28, 16},   {28, 16},
     },
    {
     // 0,0 to 28,-16
     {3, -2},  {6, -4},  {8, -5},  {11, -6},  {12, -7},  {14, -8},  {16, -9},  {17, -10},
...
UBYTE pro_sprites[] = {
    0x03, 0x00, 0x0F, 0x00, 0x1F, 0x06, 0x3F, 0x0C, 0x7F, 0x29, 0x7F, 0x4F, 0xFF, 0x1F, 0xFF, 0x0E, 0xFE, 0x3B, 0xFE,
    0x1F, 0x78, 0x1F, 0x7C, 0x1F, 0x3C, 0x0F, 0x1C, 0x07, 0x0E, 0x03, 0x03, 0x01, 0xC0, 0x00, 0xF0, 0x00, 0xF8, 0x10,
    0xFC, 0x48, 0xFE, 0x14, 0xFE, 0x00, 0xE7, 0x5A, 0xC0, 0xBF, 0x00, 0xFF, 0x80, 0xFF, 0xC0, 0xFE, 0x00, 0xFE, 0x00,
    0xFC, 0x00, 0xF8, 0x00, 0xF0, 0x00, 0xC0, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x02, 0x02, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};

UWORD pro_pal[] = {
    0x0000, 0x5AD6, 0x2108, 0x520F, 0x0D02, 0x7BBD, 0x42B0, 0x737A,
};
UWORD pro_pal2[] = {
    0x0000, 0x1084, 0x0000, 0x7FFF, 0x0D02, 0x1DC9, 0x0D02, 0x7FFF,
};

UBYTE pro_dma[] = {32,   8,    4,  0x86, 32,   56,   4,  0x86, 80,   56,   4,  0x86, 64,   104, 4,
                   0x86, 56,   40, 6,    0x86, 88,   24, 6,    0x86, 40,   88, 6,    0x86, 72,  120,
                   6,    0x86, 40, 152,  6,    0x86, 72, 128,  0,    0x86, 72, 136,  2,    0x86};
...
static UBYTE b_gems_inuse(UBYTE x)
{
    UBYTE n;
    struct DUDESTAT *st;
...
static BYTE mrel[8] = {0, -1, 0, 1, -1, 0, 1, 0};
...
UBYTE touch_guy(UBYTE x, UBYTE n, BYTE dir)
{
    ...
    return tx + 1 >= ch[n].x && tx <= ch[n].x + 1 && ty + 1 >= ch[n].y && ty <= ch[n].y + 1;
}
